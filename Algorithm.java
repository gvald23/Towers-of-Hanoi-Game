    ...
    public static void loopAlgorithm(int numDisks){
        if (numDisks%2 == 0){ //even number of disks
            while (!col1.isEmpty() || !col2.isEmpty()){
                ...
                //col1-col3
                if (col3.isEmpty() || col1.get(col1.size()-1) < col3.get(col3.size()-1)){ //col1 to col3
                    col3.add(col1.get(col1.size()-1));
                    col1.remove(col1.size()-1);
                }
                else if (col1.isEmpty() || col1.get(col1.size()-1) > col3.get(col3.size()-1)){ //col3 to col1
                    col1.add(col3.get(col3.size()-1));
                    col3.remove(col3.size()-1);
                }

                //col2-col3
                if (col3.isEmpty() || col2.get(col2.size()-1) < col3.get(col3.size()-1)){ //col2 to col3
                    col3.add(col2.get(col2.size()-1));
                    col2.remove(col2.size()-1);
                }
                else if (col2.isEmpty() || col2.get(col2.size()-1) > col3.get(col3.size()-1)){ //col3 to col2
